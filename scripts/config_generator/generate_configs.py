...
Example:
  python scripts/config_generator/generate_configs.py --interactive
  python scripts/config_generator/generate_configs.py --select all
  python scripts/config_generator/generate_configs.py --select plan_flip,max_connection_conn_storm,memory_pressure
"""
